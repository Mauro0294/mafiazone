...
INSERT INTO `users` (`id`, `gebruikersnaam`, `email`, `wachtwoord`, `cashgeld`, `bankgeld`, `power`, `kogels`, `credits`, `moorden`, `gezondheid`) VALUES
(1, 'Testuser', 'testuser@hotmail.com', '12345678', 30000, 507350, 4197, 0, 0, 2, 100),
